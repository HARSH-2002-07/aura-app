      ...
      <div className="w-full max-w-md space-y-8 rounded-2xl border border-border/50 bg-background/50 p-8 shadow-2xl backdrop-blur-sm">
        ...
        <form className="mt-8 space-y-6" action={signup}>
          ...
          <div>
            <button
              type="submit"
              className="flex w-full justify-center rounded-md bg-accent px-4 py-2 text-sm font-medium text-accent-foreground hover:bg-accent/90 focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 transition-colors"
            >
              Sign up
            </button>
          </div>
